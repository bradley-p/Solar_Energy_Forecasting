...
#Logan
Site = 'http://forecast.weather.gov/MapClick.php?w0=t&w3u=1&w4=sky&w5=pop&w7=rain&AheadHour=*&Submit=Submit&FcstType=digital&lat=1.76553&lon=-111.82256999999998&site=all&unit=0&dd=&bw='
...
def getWeatherOnePage(nowTime, daysAhead):
    ...
    pageString = urllib2.urlopen(req, timeout=4).read() #added time out
